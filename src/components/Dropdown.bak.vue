<template>
    <div class="form-group dropdown" :class="classes" v-click-outside="closeDropDown" :style="{minWidth: minWidth}">
        <div class="click-area" @click="toggleDropDown" @focus="openDropDown" @keyup.down="openDropDown" :tabindex="tabindex">
            ...
            <input type="text" :value="selectedText" :placeholder="placeholder">
